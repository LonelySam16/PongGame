...
Color Dark_Green = Color{20,165,135,255};
Color Light_Green = Color{130,205,185,255};
Color Yellow = Color{240,215,85,255};
...
int main () 
{
    ...
    while(WindowShouldClose() == false) //X button ba 'esc' tiple bondho hoye jabe
    {
        BeginDrawing();
